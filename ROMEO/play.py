...
import ffmpeg
import requests
from CFC.fonts import CHAT_TITLE
from PIL import Image, ImageDraw, ImageFont
from config import ASSISTANT_NAME, BOT_USERNAME, IMG_1, IMG_2, IMG_5
from CFC.filters import command, other_filters
from CFC.queues import QUEUE, add_to_queue
from StrayCoder.main import call_py, user
from CFC.utils import bash
...
async def generate_cover(thumbnail, title, userid, ctitle):
    ...
    image2 = Image.open("StrayCoder/music.png")
